...
export class RegistracijaComponent implements OnInit{
  ...
  collect() {
    if(this.register.valid){
      this.httpKlijent.post(`${MojConfig.adresa_servera}/KrajnjiKorisnik/Snimi`, this.register.value).subscribe(x=>{
  ...
  private fetchKrajnjiKorisnici() : void{
    this.httpKlijent.get(MojConfig.adresa_servera+ "/KrajnjiKorisnik/GetAll").subscribe((x:any)=>{
